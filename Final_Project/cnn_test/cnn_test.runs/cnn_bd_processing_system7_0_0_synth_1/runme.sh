...
HD_PWD='D:/Vivado/cnn_test/cnn_test.runs/cnn_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_bd_processing_system7_0_0.tcl
