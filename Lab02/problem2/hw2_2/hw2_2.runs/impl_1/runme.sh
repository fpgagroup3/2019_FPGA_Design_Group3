...
HD_PWD='D:/Vivado/hw2_2/hw2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log breathing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source breathing.tcl -notrace
