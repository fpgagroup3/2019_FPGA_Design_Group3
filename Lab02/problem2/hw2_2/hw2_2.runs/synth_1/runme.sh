...
HD_PWD='D:/Vivado/hw2_2/hw2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breathing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breathing.tcl
