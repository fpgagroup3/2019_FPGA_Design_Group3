...
HD_PWD='D:/Vivado/hw2_PWM/hw2_PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_Decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_Decoder.tcl
