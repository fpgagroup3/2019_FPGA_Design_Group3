...
HD_PWD='D:/FPGA/LAB02_HW/p3/block_top/block_top.runs/design_1_state_a_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_state_a_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_state_a_0_0.tcl
