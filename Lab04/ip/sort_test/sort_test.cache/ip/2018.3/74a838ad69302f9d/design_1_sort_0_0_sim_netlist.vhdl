...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sort is
  ...
  attribute SOFT_HLUTNM of \next_counter_reg[0]_i_1\ : label is "soft_lutpair3";
  attribute XILINX_LEGACY_PRIM of \next_counter_reg[1]\ : label is "LD";
  attribute SOFT_HLUTNM of \next_counter_reg[1]_i_1\ : label is "soft_lutpair4";
  attribute XILINX_LEGACY_PRIM of \next_counter_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \next_counter_reg[2]_i_1\ : label is "soft_lutpair3";
  attribute XILINX_LEGACY_PRIM of next_valid_reg : label is "LD";
  attribute SOFT_HLUTNM of next_valid_reg_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \nums[0][0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \nums[0][1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \nums[0][3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nums[0][3]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nums[1][3]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \nums[3][3]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \nums[4][3]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \nums[5][3]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \nums[7][0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \nums[7][1]_i_1\ : label is "soft_lutpair2";
