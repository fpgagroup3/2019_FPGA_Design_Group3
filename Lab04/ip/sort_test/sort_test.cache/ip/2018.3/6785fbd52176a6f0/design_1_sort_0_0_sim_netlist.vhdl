...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sort is
  ...
  attribute SOFT_HLUTNM of \nums[0][0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \nums[0][1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \nums[0][3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \nums[0][3]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \nums[1][3]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \nums[2][3]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \nums[3][3]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nums[4][3]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nums[6][3]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \nums[7][0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \nums[7][1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \nums[7][3]_i_2\ : label is "soft_lutpair0";
begin
