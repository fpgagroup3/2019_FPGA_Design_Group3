...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sort is
  ...
  attribute SOFT_HLUTNM of \nums[0][1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \nums[0][2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \nums[0][3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \nums[7][0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \nums[7][1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \nums[7][2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \nums[7][3]_i_2\ : label is "soft_lutpair2";
...
\nums[2][3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D4"
    )
        port map (
...
\nums[2][3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"55D5DDFD00404454"
    )
        port map (
...
\nums[3][3]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\nums[5][3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"008088A8AAEAEEFE"
    )
        port map (
