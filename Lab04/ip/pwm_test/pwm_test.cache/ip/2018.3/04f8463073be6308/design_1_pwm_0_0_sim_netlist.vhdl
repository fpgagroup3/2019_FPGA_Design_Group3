...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_led is
  ...
  attribute SOFT_HLUTNM of \counter_256[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter_256[1]_i_1\ : label is "soft_lutpair3";
...
\counter_256[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B4"
    )
        port map (
...
\counter_256[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
