...
HD_PWD='D:/Vivado/lab5_total/lab5_total.runs/total_1_total_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log total_1_total_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source total_1_total_0_0.tcl
