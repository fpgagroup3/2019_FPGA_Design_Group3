...
HD_PWD='D:/Vivado/lab5_total/lab5_total.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log total_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source total_1_wrapper.tcl -notrace
