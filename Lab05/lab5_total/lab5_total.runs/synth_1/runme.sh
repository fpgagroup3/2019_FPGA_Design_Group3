...
HD_PWD='D:/Vivado/lab5_total/lab5_total.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log total_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source total_1_wrapper.tcl
